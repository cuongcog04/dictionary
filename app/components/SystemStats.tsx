            ...
            <div className="p-6 rounded-2xl bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/20">
                ...
                <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                    <li className="flex items-center justify-between">
                        ...
                        <span className="font-semibold text-gray-900 dark:text-white text-base">357,729</span>
                    </li>
                    <li className="flex items-center justify-between">
                        <span>Định nghĩa chi tiết:</span>
                        <span className="font-semibold text-gray-900 dark:text-white text-base">443,116</span>
                    </li>
                </ul>
            </div>
            <div className="p-6 rounded-2xl bg-amber-50/50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/20">
                <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white flex items-center gap-2">
