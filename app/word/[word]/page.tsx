...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: {
            ...
            images: [
                {
                    url: `https://minhqnd.com/api/og?title=${encodeURIComponent(word + ' là gì?')}&description=${encodeURIComponent(firstDefinition.slice(0, 100))}&footer=${encodeURIComponent('dict.minhqnd.com - API Từ Điển Tiếng Việt & Đa Ngôn Ngữ Miễn Phí | @minhqnd')}&brand=${encodeURIComponent('Từ điển API')}`,
                    width: 1200,
                    height: 630,
